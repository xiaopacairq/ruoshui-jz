...
<body style="padding: 20px;">
    <div class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="id" required lay-verify="required"
                    value="<?= $project_total['id'] ?>" autocomplete="off" disabled>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" id="add_time" name="add_time" required lay-verify="required"
                    value="<?= $project_total['add_time'] ?>" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">@ 项目负责人</label>
            <div class="layui-input-inline">
                <input type="text" name="r_name" required lay-verify="required" autocomplete="off" placeholder="格式：张XX"
                    value="<?= $project_total['r_name'] ?>" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="cid" lay-verify="required">
                    ...
                    <option value=<?= $project_c['cid'] ?>
                        <?= ($project_total['cid'] == $project_c['cid']) ? 'selected' : '' ?>>
                        <?= $project_c['c_name'] ?>
                    </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="p_name" required lay-verify="required" autocomplete="off" placeholder="项目名称"
                    value="<?= $project_total['p_name'] ?>" class=" layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"># 已结余费用</label>
            <div class="layui-input-inline">
                <input type="text" id="p_money" name="p_money" placeholder="格式：199.99" class="layui-input" required
                    value="<?= $project_total['p_money'] ?>" lay-verify="required" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"># 总费用</label>
            <div class="layui-input-inline">
                <input type="text" id="t_money" name="t_money" placeholder="格式：199.99" class="layui-input" required
                    value="<?= $project_total['t_money'] ?>" lay-verify="required" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">结余情况</label>
            <div class="layui-input-block">
                <input type="radio" name="is_ok" value="0" title="已结余"
                    <?= $project_total['is_ok'] == 0 ? 'checked' : '' ?>>
                <input type="radio" name="is_ok" value="1" title="部分结余"
                    <?= $project_total['is_ok'] == 1 ? 'checked' : '' ?>>
                <input type="radio" name="is_ok" value="2" title="未结余"
                    <?= $project_total['is_ok'] == 2 ? 'checked' : '' ?>>
            </div>
        </div>
    ...
    function save() {
        ...
        if (add_time == '' || r_name == '' || cid == '' || p_name == '' || p_money == '' || t_money == '' || is_ok ==
            ...
            $.post('/project/project_total_edit_save', {
                id,
                add_time,
                r_name,
                cid,
